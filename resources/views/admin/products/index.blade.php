...
@section('breadcrumb')
    <li>
        ...
        <a class="parent-item" href="{{ route('product.index') }}">Products</a>
        ...
        <div class="col-md-12">
            <div class="card card-box">
                <div class="card-head">
                    ...
                    <a href="{{ route('product.create') }}" id="addRow" class="btn btn-primary pull-right mr-3 mt-1">
                        Add product
                    ...
                    <div class="table-scrollable">
                        <table class="table table-hover order-column full-width" id="example4">
                            ...
                            <tr>
                                ...
                                <th class="center">Product color</th>
                            ...
                            @foreach($products as $key => $product)
                                <tr class="">
                                    ...
                                    <td class="center">{{ $product->gender }}</td>
                                    <td class="center">{{ $product->color->name }}</td>
                                    <td class="center">{{ $product->size->name }}</td>
                                    <td class="center"><img src="{{ asset($product->image) }}" alt="" height="80px">
                                    </td>
